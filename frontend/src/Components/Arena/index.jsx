...
const Arena = ({characterNFT, setCharacterNFT}) =>{
  ...
  const runAttackAction = async () => {
    try {
      ...
      console.log("Error while running attack: ",error);
      setAttackState('');
    }
  };

  const onAttackComplete = async(newPlayerHp,newBossHp)=>{
  ...
  useEffect(()=>{
    ...
    if(ethereum){
      ...
      setGameContract(myEpicGameContract);
    }else{
